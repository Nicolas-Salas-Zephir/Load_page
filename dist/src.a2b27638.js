...
},{"./gsap-core.js":"node_modules/gsap/gsap-core.js","./CSSPlugin.js":"node_modules/gsap/CSSPlugin.js"}],"src/image.js":[function(require,module,exports) {
"use strict";
...
var Image = /*#__PURE__*/function () {
  ...
  _createClass(Image, [{
    ...
    value: function show() {
      ...
      setTimeout(function () {
        _this3.arrImage.splice(_this3.arrImage.length, 0, _this3.arrImage[0]);

        _this3.insertInTheHTML();

        _this3.removeClass();

        _this3.arrImage.shift();
      }, 1000);
      this.addClass();
    }
  }, {
    ...
    key: "insertInTheHTML",
    value: function insertInTheHTML() {
      if (this.DOM.el) {
        this.DOM.el.appendChild(this.arrImage[0]);
      } else {
        console.error("\"".concat(this.id, "\" n'est pas un id valide"));
      }
    }
  }, {
    key: "timeout",
...
},{"gsap":"node_modules/gsap/index.js"}],"node_modules/@barba/core/dist/barba.umd.js":[function(require,module,exports) {
var define;
...
},{}],"src/animations/animEnter.js":[function(require,module,exports) {
"use strict";
...
Object.defineProperty(exports, "animEnter", {
  enumerable: true,
  get: function () {
    return _animEnter.default;
  }
});
Object.defineProperty(exports, "animLeave", {
  enumerable: true,
  get: function () {
    return _animLeave.default;
  }
});

var _animEnter = _interopRequireDefault(require("./animEnter"));

var _animLeave = _interopRequireDefault(require("./animLeave"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./animEnter":"src/animations/animEnter.js","./animLeave":"src/animations/animLeave.js"}],"src/transitionPage.js":[function(require,module,exports) {
"use strict";
...
},{"@barba/core":"node_modules/@barba/core/dist/barba.umd.js","./animations":"src/animations/index.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
var _transitionPage = _interopRequireDefault(require("./transitionPage"));
...
var index = new Index();
},{"./styles.scss":"src/styles.scss","./image":"src/image.js","./transitionPage":"src/transitionPage.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
